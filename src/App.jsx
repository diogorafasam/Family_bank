...
function Settings({user,dark,setDark,onLogout,d,familyId,toast}){
  const T=useT();
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",minWidth:0}}>
        ...
        <div className="main-wrap pad" style={{flex:1,overflow:"auto",padding:"18px",background:T.bg}}>
          {dataLoading?<Spinner/>:<>
            ...
            {tab==="settings"&&<Settings user={user} dark={dark} setDark={setDark} onLogout={logout} d={d} familyId={familyId} toast={toast}/>}
          </>}
        </div>
      </div>
    </div>
